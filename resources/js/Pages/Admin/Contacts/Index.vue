            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-for="(contact, index) in contacts.data" :key="contact.id">
                        ...
                        <td>
                            <button @click="toggleStatus(contact)" :class="['badge-btn', contact.status === 'done' ? 'badge-success' : 'badge-warning']" title="Bấm để đổi trạng thái">
...
.truncate-content { max-width: 300px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
.badge-btn { padding: 0.4rem 0.8rem; border-radius: 20px; font-size: 0.8rem; font-weight: 600; cursor: pointer; border: none; transition: all 0.2s; }
.badge-success { background: #ecfdf5; color: #059669; }
.badge-success:hover { background: #d1fae5; }
.badge-warning { background: #fffbeb; color: #d97706; }
.badge-warning:hover { background: #fef3c7; }
